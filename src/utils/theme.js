...
export const setSuccessColor = (color) => themeManager.setSuccessColor(color)
export const setWarningColor = (color) => themeManager.setWarningColor(color)
export const setDangerColor = (color) => themeManager.setDangerColor(color)
export const setInfoColor = (color) => themeManager.setInfoColor(color)
export const setCssVar = (name, value) => themeManager.setCssVar(name, value)
export const getCssVar = (name) => themeManager.getCssVar(name)
