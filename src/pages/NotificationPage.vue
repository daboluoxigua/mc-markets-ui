<template>
  <div class="notification-page">
    ...
    <!-- 使用 HTML 片段作为正文内容 -->
    <DemoSection title="使用 HTML 片段作为正文内容">
      <div class="example-notification-block">
    ...
    <!-- 函数形式的 message 2.9.0 -->
    <DemoSection title="函数形式的 message 2.9.0">
      <div class="example-notification-block">
