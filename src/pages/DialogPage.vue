  ...
  <div class="dialog-page">
    ...
    <DemoSection title="基础用法">
      <div class="example-dialog-block">
        <div class="example-demonstration">Dialog 弹出一个对话框，适合需要定制性更大的场景。需要设置 model-value / v-model 属性，它接收 Boolean，当为 true 时显示 Dialog。 Dialog 分为两个部分：body 和 footer，footer 需要具名为 footer 的 slot。 title 属性用于定义标题，它是可选的，默认值为空。 最后，本例还展示了 before-close 的用法。</div>
    ...
    <DemoSection title="自定义内容">
      <div class="example-dialog-block">
        <div class="example-demonstration">对话框的内容可以是任何东西，甚至是一个表格或表单。 此示例显示如何在 Dialog 中使用 Element Plus 的表格和表单。</div>
        <div class="dialog-demo-container">
          ...
          <m-dialog v-model="dialogTableVisible" title="Shipping address" width="800">
          ...
          <m-dialog v-model="dialogFormVisible" title="Shipping address" width="500">
            <m-form :model="form">
              ...
              <m-form-item label="Zones" :label-width="formLabelWidth">
                <m-select v-model="form.region" placeholder="Please select a zone">
    ...
    <DemoSection title="自定义头部">
      <div class="example-dialog-block">
        <div class="example-demonstration">header 可用于自定义显示标题的区域。 为了保持可用性，除了使用此插槽外，使用 title 属性，或使用 titleId 插槽属性来指定哪些元素应该读取为对话框标题。</div>
        <div class="dialog-demo-container">
          <m-button plain @click="customHeaderVisible = true">
            Open Dialog with customized header
          </m-button>

          <m-dialog v-model="customHeaderVisible" :show-close="false" width="500">
    ...
    <DemoSection title="嵌套的对话框">
      <div class="example-dialog-block">
        <div class="example-demonstration">如果需要在一个 Dialog 内部嵌套另一个 Dialog，需要使用 append-to-body 属性。</div>
        <div class="dialog-demo-container">
    ...
    <DemoSection title="内容居中">
      <div class="example-dialog-block">
        <div class="example-demonstration">通过设置 center 属性可以让 Dialog 的 header 和 footer 部分居中排列。</div>
        <div class="dialog-demo-container">
          ...
          <m-dialog
            ...
            center
          >
            <span>It should be noted that the content will not be aligned to center by default</span>
            <template #footer>
              <div class="dialog-footer">
    ...
    <DemoSection title="居中对话框">
      <div class="example-dialog-block">
        <div class="example-demonstration">通过设置 align-center 属性可以让 Dialog 水平垂直对齐对话框。</div>
        <div class="dialog-demo-container">
          ...
          >
            ...
            <template #footer>
              <div class="dialog-footer">
                <m-button @click="alignCenterDialogVisible = false">Cancel</m-button>
                <m-button type="primary" @click="alignCenterDialogVisible = false">
                  Confirm
                </m-button>
              </div>
            </template>
    ...
    <DemoSection title="关闭时销毁">
      <div class="example-dialog-block">
        <div class="example-demonstration">当需要重新渲染 Dialog 内容时，可以设置 destroy-on-close 属性。</div>
        <div class="dialog-demo-container">
          ...
          >
            ...
            <template #footer>
              <div class="dialog-footer">
                <m-button @click="destroyOnCloseVisible = false">Cancel</m-button>
    ...
    <DemoSection title="可拖拽对话框">
      <div class="example-dialog-block">
        <div class="example-demonstration">通过设置 draggable 属性可以让 Dialog 变为可拖拽的。</div>
        <div class="dialog-demo-container">
    ...
    <DemoSection title="全屏">
      <div class="example-dialog-block">
        <div class="example-demonstration">通过设置 fullscreen 属性可以让 Dialog 变为全屏的。</div>
        <div class="dialog-demo-container">
    ...
    <DemoSection title="模态框">
      <div class="example-dialog-block">
        <div class="example-demonstration">通过设置 modal 属性可以控制是否需要遮罩层。</div>
        <div class="dialog-demo-container">
    ...
    <DemoSection title="自定义动画 2.10.5">
      <div class="example-dialog-block">
        <div class="example-demonstration">通过设置 transition 属性可以自定义对话框的动画效果。</div>
        <div class="dialog-demo-container">
          ...
          >
            ...
            <template #footer>
              <div class="dialog-footer">
                <m-button @click="customTransitionVisible = false">Cancel</m-button>
                <m-button type="primary" @click="customTransitionVisible = false">
                  Confirm
                </m-button>
              </div>
            </template>
...
const dialogApiProps = [
  ...
  },
  {
    ...
    type: "string / object",
    default: "dialog-fade",
    description: "对话框动画的自定义过渡配置。 可以是一个字符串（过渡名称），也可以是一个包含 Vue 过渡属性的对象。",
    version: "2.10.5"
  },
  {
    name: "custom-class",
