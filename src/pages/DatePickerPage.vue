          ...
          <m-date-picker v-model="value7" placeholder="Pick a day">
            <template #default="{ cellValue, cell }">
              <div class="cell" :class="{ current: cell && cell.type === 'current' }">
                ...
                <span v-if="cell && cell.type === 'current'" class="holiday"></span>
              </div>
            </template>
          </m-date-picker>
        </div>
...
import { MDatePicker } from "@mc-markets/ui";
...
const datePickerApiProps = [
  ...
  },
  {
    ...
    type: "array",
    default: "—",
    description: "组件的空值配置 [参考config-provider](/en-US/component/config-provider.html#empty-values-configurations)",
    version: "2.7.0"
  },
  {
    name: "value-on-clear",
    ...
    default: "—",
    description: "清空选项的值 [参考 config-provider](/en-US/component/config-provider.html#empty-values-configurations)",
    version: "2.7.0"
  },
  {
    ...
    type: "array",
    default: ":::",
    description: "Tooltip 可用的 positions 请查看[popper.js 文档](https://popper.js.org/docs/v2/modifiers/flip/#fallbackplacements)",
    version: "2.8.4"
  },
  {
    name: "placement",
